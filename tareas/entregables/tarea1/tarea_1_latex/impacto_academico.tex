...
\begin{enumerate}
    ...
    \item \textbf{Estilos journal oficiales}: ejm. IEEEtran.cls, Nature.cls, Springer.cls garantizan cumplimiento de formatos editoriales.
\end{enumerate}
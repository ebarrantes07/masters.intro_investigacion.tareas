...
\subsection{Título}
\textit{Diseño e implementación de un método para la ejecución de aplicaciones de computación paralela basadas en MPI en un clúster de Kubernetes} (Design and Implementation of a Method for Running MPI-Based Parallel Computing Applications in a Kubernetes Cluster). Trabajo Final de Graduación para optar por el grado de Licenciatura en Ingeniería en Ciencias de la Computación e Informática, Universidad de Costa Rica, 2024.

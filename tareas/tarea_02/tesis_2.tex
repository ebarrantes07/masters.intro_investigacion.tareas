...
La investigación empleó una metodología experimental en dos fases, apoyada en el sistema MAUI (\textit{Multimodal Affective User Interface}), herramienta de investigación desarrollada en el laboratorio de la directora de tesis \cite{nasoz2004}.
...
En cuarto lugar, la sección denominada ``Visualización de los Resultados'' (\textit{Visualization of the Results}) resulta confusa: en realidad es una descripción de las capacidades del sistema MAUI con capturas de pantalla, más que una presentación analítica de resultados. Esta denominación no sigue la convención estándar de tesis y puede inducir a error.
